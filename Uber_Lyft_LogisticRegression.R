...
list.of.packages <- c("ggplot2","pls","glmnet","Matrix","smbinning","ROCR","cvms","gbm","RCurl","curl","httr","InformationValue",
                      "car","caTools","randomForest","ISLR","plyr","knitr","dplyr","readxl","scales","reshape2","rpart.plot",
                      "tidyverse","tibble","RColorBrewer","kableExtra","mctest","rpart","viridis","formatR","DescTools","ggpubr",
                      "psych","caret","Metrics","reshape","hrbrthemes","Information","MASS","e1071","class","pROC","corrplot",
                      "mltools","lubridate")
